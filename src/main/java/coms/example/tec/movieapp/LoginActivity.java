...
public class LoginActivity extends Activity {
    ...
    private void loadSettings() {
        ...
        global.users = fh.loadUsers(LoginActivity.this);
    }
    ...
    private boolean searchUser(String _username,String _password) {
        ...
        for (int i = 0; i < users.size();i++) {
            ...
            if (user.getUsername().equals(_username) && user.getPassword().equals(_password) && !user.isBlocked()) {
...
//------------------------------------------------------------------------------------------------------------------------
        ...
        Actor a6 = new Actor("Morena","Baccarin");
        ...
        Director director3 = new Director("David","Leitch");
        Genre genre3 = new Genre("Action");


        Movie m3 = new Movie(3,"Deadpool 2",actorsList3,director3,genre3,2018,
                comments,"https://image.ibb.co/jMSDCo/5afca4f547bac.jpg",
                "Pelicula de accion, basada en Deadpool");
        movieList.add(m3);
        ...
        FileHelper fh = new FileHelper();
        fh.saveMovies(movieList,LoginActivity.this);
        fh.saveUsers(users,LoginActivity.this);
